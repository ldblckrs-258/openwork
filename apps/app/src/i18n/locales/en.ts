...
export default {
  ...
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "OpenWork handles sign-in and token refresh, then gives the bundled OpenCode engine a local gateway to the MCP tools. Use this for servers that need a pre-registered OAuth app, such as Slack MCP.",
  "mcp.oauth_advanced_title": "OpenWork-managed OAuth",
